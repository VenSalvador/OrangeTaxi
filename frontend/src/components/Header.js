                ...
                {!isMobile && (
                    <nav>
                        <ul className="d-flex gap-4 list-unstyled mb-0">
                            <li><a href="whatsnew" className="text-dark text-decoration-none">What's New</a></li>
                            <li><a href="partner" className="text-dark text-decoration-none">Be Our Partner</a></li>
            ...
            {isMobile && isMenuOpen && (
                ...
                >
                    <ul className="list-unstyled mb-0">
                        <li className="mb-2"><a href="whatsnew" className="text-dark text-decoration-none">What's New</a></li>
                        <li className="mb-2"><a href="partner" className="text-dark text-decoration-none">Be Our Partner</a></li>
